...
public final class ImagePane extends JComponent {
	...
	public Dimension getPreferredSize() {
		return sourceImage != null ? new Dimension(sourceImage.getWidth(), sourceImage.getHeight())
			...
			if (sourceImage != null) {
				...
				case FIT:
					...
					AffineTransform at = AffineTransform.getScaleInstance(
							(double) image.getWidth() / sourceImage.getWidth(),
							(double) image.getHeight() / sourceImage.getHeight());
